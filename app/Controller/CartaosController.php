...
class CartaosController extends AppController{
	...
	public function index(){
		...
		//$this->set('realiza', $this->Cartao->realizaTransacao('1', 'MCARD', "5286028516049066", "Augusto Matraga", "12628161818", "890", "062014", "3"));
		//$this->set('cancel', $this->Cartao->cancelaTransacao(131));
		//$this->set('consulta', $this->Cartao->consultaTransacao('131'));
	...
	public function pagamento($tipo){//$tipo
		$valorDaCompra=CakeSession::read('valorDaCompra');
		$bandeiras = array('American Express' => 'AMEX', 'Diners Club' => 'DINERS', 'MasterCard' => 'MCARD', 'Visa' => 'VISA');
		//$this->set('parcelas', $this->Cartao->numParcelas($valorDaCompra, $bandeiras[$tipo]));
