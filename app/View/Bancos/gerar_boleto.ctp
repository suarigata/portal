...
<TABLE style="margin: 10px;" cellSpacing=0 cellPadding=0 border=0 class=Boleto>
  ...
  <TR>
    ...
    <TD class=BoletoValorDireito> <?php echo $vencimento?> </TD>
  </TR>  
  <TR>
  ...
  <TR>
    <TD colspan=10 class=BoletoValorEsquerdo style='text-align: left; padding-left : 0.1cm'><?php echo $razao?></TD>
    <TD class=BoletoValorDireito><?php echo $cedente?></TD>
  </TR>   
  <TR>
    ...
    <TD class=BoletoTituloDireito>CNPJ</TD>
  </TR>
  <TR>
    <TD colspan=3 class=BoletoValorEsquerdo><?php echo $criacao?></TD>
    <TD colspan=4 class=BoletoValorEsquerdo><?php echo $id?></TD>
    <TD class=BoletoValorEsquerdo>RC</TD>
    <TD class=BoletoValorEsquerdo>N</TD>
    <TD class=BoletoValorEsquerdo>DataDoProces</TD>
    <TD class=BoletoValorDireito><?php echo $cnpj?></TD>
  </TR>  
  <TR>
  ...
  <TR>
    ...
    <TD class=BoletoValorDireito><?php echo $valor?></TD>
  </TR>  
  <TR>
  ...
  <TR>
    ...
    <TD colspan=8 Class=BoletoValorSacado><?php echo $cliente?></TD>
  </TR> 
  <TR>
    <TD colspan=10 Class=BoletoValorSacado><?php echo $endereco?></TD>
  </TR>
